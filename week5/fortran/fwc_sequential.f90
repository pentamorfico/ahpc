...
contains
    ...
    subroutine write_hdf5(world, filename, iteration)
        ...
        dims(2) = world%latitude
        dims(1) = world%longitude
    ...
    subroutine simulate(num_of_iterations, model_filename, output_filename)
        ...
        do j = 2, latitude - 1
            do i = 2, longitude - 1
                albedo(i, j) = global_world%albedo_data(i - 1, j - 1)
            end do
        end do
...
end module fwc_module


program fwc_sequential
    use fwc_module
